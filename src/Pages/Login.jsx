          ...
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
            ...
            <div className="md:w-7/12 flex justify-center">
              <div className="w-full max-w-lg text-center text-white">
                <img src="https://repository-images.githubusercontent.com/419507496/cfcc1354-86ac-432e-823a-da56c21302ba"
                  alt="Logo" className="mx-auto rounded mb-6" />
                <hr className="border-blue-300 mb-6" />
                <h2 className="text-4xl font-bold mb-4">
                  Smart Tracking for Smarter Living.
                </h2>
                <p className="text-lg">
                  A smarter way to manage your day-to-day expenses.
                </p>
              </div>
            </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6 md:p-10">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button type="submit" disabled={!isFormValid || loading}
                    className={`w-full flex justify-center items-center gap-2 py-3 rounded-lg text-white font-semibold ${isFormValid
